...
public abstract class VerticalTextile(int width, int height) : TextileBase(width, height, new uint[height.GetArraySize() * width])
{
    ...
    internal override TextileIndex ToIndex(int ConsecutiveIndex, int NonConsecutiveIndex) => new(NonConsecutiveIndex, ConsecutiveIndex);
